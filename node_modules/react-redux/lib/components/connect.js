...
var _mapDispatchToProps = _interopRequireDefault(require("../connect/mapDispatchToProps"));

var _mapStateToProps = _interopRequireDefault(require("../connect/mapStateToProps"));

var _mergeProps = _interopRequireDefault(require("../connect/mergeProps"));
...
function connect(mapStateToProps, mapDispatchToProps, mergeProps, {
  ...
  _mapStateToProps.default, 'mapStateToProps');
  const initMapDispatchToProps = match(mapDispatchToProps, // @ts-ignore
  _mapDispatchToProps.default, 'mapDispatchToProps');
  const initMergeProps = match(mergeProps, // @ts-ignore
  _mergeProps.default, 'mergeProps');
